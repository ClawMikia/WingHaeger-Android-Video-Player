...
public final class ActivityPlaylistListBinding implements ViewBinding {
  ...
  private ActivityPlaylistListBinding(@NonNull CoordinatorLayout rootView,
      @NonNull BottomNavigationView bottomNav, @NonNull Button btnNewPlaylist,
  ...
  public static ActivityPlaylistListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPlaylistListBinding((CoordinatorLayout) rootView, bottomNav,
          btnNewPlaylist, recycler, toolbar);
    }
